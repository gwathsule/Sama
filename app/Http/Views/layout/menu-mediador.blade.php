...
<li><a href="#addUsersDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-user-circle-o"></i>Entidades</a>
    <ul id="addUsersDropdown" class="collapse list-unstyled ">
        <li><a href="{{route('mediador.home.new.entidade')}}">Cadastrar</a></li>
        <li><a href="{{route('mediador.home.list.entidade')}}">Listar</a></li>
    </ul>
</li>
<li><a href="{{route('mediador.home.necessidades.novas')}}"> <i class="fa fa-hourglass"></i>Necessidades</a></li>
