...
<li><a href="{{route('rotary.home')}}"> <i class="icon-home"></i>Home</a></li>
...
<li><a href="{{route('rotary.home.doacoes.novas')}}"> <i class="fa fa-heart-o"></i>Novas Doações</a></li>
<li><a href="{{route('rotary.home.doacoes.andamento')}}"> <i class="fa fa-archive"></i>Doações em processo</a></li>